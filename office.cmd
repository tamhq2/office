...
echo:
call :KMSActivation     & cls & endlocal & goto :MainMenu
goto :MainMenu
...
cls
color 07
title  Only ACTIVE OFFICE - IT VIETNAM 2023
...
set "_title=Only ACTIVE OFFICE - IT VIETNAM 2023"
set _gui=
...
echo.
echo.
cls&setlocal&set "ActWindows=0"&set "ActOffice=1"&call :Activation_Start&endlocal&cls&exit
pause
...
if %WinVL% EQU 0 (
if %ActWindows% EQU 0 (
  echo.&echo Only ACTIVE OFFICE 2023...
  ) else (
  if %SSppHook% EQU 0 (
...
if %W1nd0ws% EQU 1 if %ActWindows% EQU 0 (echo.& echo Only ACTIVE OFFICE 2023...)
...
echo:       _______________________________________________________________
echo:          
call :_color2 %_White% "            " %_Yellow% "Enter a menu option in the Keyboard :"
choice /C:1234560 /N
set _erl=%errorlevel%
